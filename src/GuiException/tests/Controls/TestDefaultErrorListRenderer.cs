...
namespace NUnit.UiException.Tests.Controls
{
    ...
    public class TestDefaultErrorListRenderer
    {
        ...
        public void IsDirty()
        {
            ...
            renderer.DrawToGraphics(_filled.Items, _filled.Items[0], _gr, viewport);
            Assert.That(renderer.IsDirty(_empty.Items, _filled.Items[0], viewport), Is.True);
            ...
            renderer.DrawToGraphics(_filled.Items, _filled.Items[0], _gr, viewport);
            Assert.That(renderer.IsDirty(_filled.Items, _filled.Items[0], new Rectangle()), Is.True);
