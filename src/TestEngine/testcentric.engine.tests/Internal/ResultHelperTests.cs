...
namespace TestCentric.Engine.Internal
{
    public class ResultHelperTests
    {
        ...
        public void AggregateTestResult()
        {
            ...
            Assert.That(combinedNode.Attributes["failed"].Value, Is.EqualTo("2"));
            Assert.That(combinedNode.Attributes["warnings"].Value, Is.EqualTo("2"));
        ...
        public void AggregateXmlNodes()
        {
            ...
            Assert.That(combined.Attributes["failed"].Value, Is.EqualTo("2"));
            Assert.That(combined.Attributes["warnings"].Value, Is.EqualTo("2"));
