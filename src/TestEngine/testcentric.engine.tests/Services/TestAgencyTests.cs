...
namespace TestCentric.Engine.Services
{
    ...
    public class TestAgencyTests
    {
        ...
        {
            "Net462AgentLauncher", "NetCore31AgentLauncher", "Net50AgentLauncher", "Net60AgentLauncher"
        };
        ...
        [TestCase("netcore-1.1", "NetCore31AgentLauncher", "Net50AgentLauncher", "Net60AgentLauncher")]
        [TestCase("netcore-2.0", "NetCore31AgentLauncher", "Net50AgentLauncher", "Net60AgentLauncher")]
        [TestCase("netcore-2.1", "NetCore31AgentLauncher", "Net50AgentLauncher", "Net60AgentLauncher")]
        ...
        [TestCase("netcore-1.1", "netcore-2.0", "NetCore31AgentLauncher", "Net50AgentLauncher", "Net60AgentLauncher")]
        [TestCase("netcore-2.1", "netcore-2.1", "NetCore31AgentLauncher", "Net50AgentLauncher", "Net60AgentLauncher")]
        ...
        [TestCase("netcore-5.0", "netcore-6.0", "Net60AgentLauncher")]
