    ...
    public sealed class FrameworkName : IEquatable<FrameworkName>
    {
        ...
        public FrameworkName(string identifier, Version version, string profile=null)
        {
            ...
            if (identifier.Length == 0)
                throw new ArgumentException("Argument must not be empty", nameof(identifier));
        ...
        public FrameworkName(string frameworkName)
        {
            ...
            if (frameworkName == "")
                throw new ArgumentException("Argument must not be the empty string", nameof(frameworkName));
            ...
            if (components.Length < 2 || components.Length > 3)
                throw new InvalidOperationException(FRAMEWORK_NAME_COMPONENT_COUNT);
            ...
            if (_identifier.Length == 0)
                throw new InvalidOperationException(FRAMEWORK_NAME_INVALID);
            ...
            for (int i = 1; i < components.Length; i++)
            {
                ...
                if (separatorIndex <0 || separatorIndex != component.LastIndexOf(KEY_VALUE_SEPARATOR))
                    throw new InvalidOperationException(FRAMEWORK_NAME_INVALID);
