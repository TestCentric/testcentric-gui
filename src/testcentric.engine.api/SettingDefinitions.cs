...
namespace NUnit.Common
{
    ...
    public static class SettingDefinitions
    {
        ...
        /// </summary>
        public static SettingDefinition<bool> SimulateUnloadError { get; } = new(nameof(SimulateUnloadError), false);

        /// <summary>
        /// Bool flag indicating that the DomainManager should inject
        /// an infinite loop for testing purposes.
        /// </summary>
        public static SettingDefinition<bool> SimulateUnloadTimeout { get; } = new(nameof(SimulateUnloadTimeout), false);
