...
public static void PatchAssemblyInfo(string sourceFile, string assemblyVersion, string assemblyFileVersion, string assemblyInformationalVersion)
{
    ReplaceFileContents(sourceFile, source =>
    {
        ...
        if (assemblyFileVersion != null)
            source = ReplaceAttributeString(source, "AssemblyFileVersion", assemblyFileVersion);
