        ...
        ChocolateyPack(CHOCO_DIR + PACKAGE_NAME + ".nuspec", 
            new ChocolateyPackSettings()
            {
                ...
                Files = new ChocolateyNuSpecContent[]
                {
                    ...
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "testcentric.pdb", Target="tools" },
                    ...
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "tc-next.pdb", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "TestCentric.Common.dll", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "TestCentric.Common.pdb", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "TestCentric.Gui.Components.dll", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "TestCentric.Gui.Components.pdb", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "TestCentric.Gui.Runner.dll", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "TestCentric.Gui.Runner.pdb", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "Experimental.Gui.Runner.dll", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "Experimental.Gui.Runner.pdb", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "nunit.uiexception.dll", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "nunit.uiexception.pdb", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "TestCentric.Gui.Model.dll", Target="tools" },
                    new ChocolateyNuSpecContent() { Source = BIN_DIR + "TestCentric.Gui.Model.pdb", Target="tools" },
