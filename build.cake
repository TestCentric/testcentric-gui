...
var NuGetGuiPackage = new NuGetPackage(
	...
	packageContent: new PackageContent()
		...
		.WithDependencies(
            KnownExtensions.Net462PluggableAgent.SetVersion("2.6.0-dev00016").NuGetPackage,
            KnownExtensions.Net60PluggableAgent.SetVersion("2.5.3-dev00008").NuGetPackage,
            KnownExtensions.Net80PluggableAgent.SetVersion("2.5.4-dev00006").NuGetPackage
        ),
	...
	packageContent: new PackageContent()
		.WithDirectories(
            ...
            new DirectoryContent("tools/Images/Tree/Visual Studio").WithFiles(
				...
				"Images/Tree/Visual Studio/Running.png", "Images/Tree/Visual Studio/Skipped.png"))
        .WithDependencies(
			KnownExtensions.Net462PluggableAgent.SetVersion("2.6.0-dev00016").ChocoPackage,
			KnownExtensions.Net60PluggableAgent.SetVersion("2.5.3-dev00008").ChocoPackage,
			KnownExtensions.Net80PluggableAgent.SetVersion("2.5.4-dev00006").ChocoPackage
        ),
